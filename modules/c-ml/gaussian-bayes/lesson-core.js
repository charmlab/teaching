...
(function () {
  ...
  /* ── linear algebra: solve A x = b (partial pivoting) ───── */
  ...
  LR.highlight = function (src) {
    ...
    while (i < s.length) {
      ...
      } else if ((m = rest.match(/^\b(np|len|range|print|def|for|in|return|if|elif|else|while|import|as|from|not|and|or|True|False|None|int)\b/))) {

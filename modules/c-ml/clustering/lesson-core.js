/* ══════════════════════════════════════════════════════════════
   lesson-core.js — shared framework for the Clustering lesson
   Canvas/plot helpers, deterministic RNG, quiz engine, Python
   highlighter, and lazy figure mounting. Real computation only.
   ══════════════════════════════════════════════════════════════ */
(function () {
  "use strict";
